                        ...
                        <div class="card-block">
                            ...
                            <fieldset id="field-register" style="display: none;">
                                <form id="form-register" class="md-float-material form-material" autocomplete="off">
                                    ...
                                    <div class="form-group form-primary">
                                        <input placeholder="Tanggal Lahir" required id="tanggalLahir" name="tanggalLahir" class="form-control" onfocus="(this.type='date')" onfocusout="(this.type='text')" type="text">
                                    </div>
                                    <div class="form-group form-primary">
